...
def auto_url_authorization(url):
    ...
    driver = webdriver.Chrome(
        options=chrome_options, executable_path=chrome_driver_path, service_log_path='NUL')
...
def oauth_validator():
    ...
    with open('./static/auth.ini', 'w') as configfile:
    ...
    if extension == "json":
        ...
        if mode == "init":
            ...
            for shelf in reviewer.shelves:
                s = [shelf.get_shelf_id(), shelf.get_shelf_name(),
